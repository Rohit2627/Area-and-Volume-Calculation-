function calculateArea() {
  ...
  if (side >= 0 && height >= 0) {
    var volumeMeters = 0.33 * sideMeters * sideMeters * heightMeters;
  } else {
  ...
  if (sideUnit === "meters" && heightUnit === "meters") {
    document.getElementById("cubicMeters").innerHTML =
      "Volume: " + volumeMeters.toFixed(2) + " cubic meters";
  } else if (sideUnit === "centimeters" && heightUnit === "centimeters") {
    document.getElementById("cubicCentimeters").innerHTML =
      "Volume: " + volumeCenti.toFixed(2) + " cubic centimeters";
  } else if (sideUnit === "kilometers" && heightUnit === "kilometers") {
    document.getElementById("cubicKilometers").innerHTML =
      "Volume: " + volumeKilo.toFixed(2) + " cubic Kilometers";
  }
}
